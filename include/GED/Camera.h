...
typedef ae2f_struct ae2f_ds_Alloc_cOwn GED_Camera_t;


/// @param This:ae2f_ds_Alloc_Owner 
#define GED_Camera_Init(This) ae2f_ds_Alloc_vOwner_InitAuto(This)

ae2f_SHAREDCALL ae2f_extern ae2f_err_t GED_Camera_BuffAll(GED_Camera_t* _this, ae2f_struct ae2f_Bmp_cSrc* dest, uint32_t background);
